...
class Index extends Component {
  ...
  componentDidMount() {
    ...
    // setInterval(() => this.moveUp('smoke4', -320), 60);
    // setInterval(() => this.moveUp('smoke5', -305), 70);
  ...
  render() {
    ...
    return (
      <svg id="aj" viewBox="0 0 640.04 387.39" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
        <title>aj</title>
